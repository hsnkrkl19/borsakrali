...
const tema34ScannerRoutes = require('./routes/tema34Scanner.routes');
const bistAlScannerRoutes = require('./routes/bistAlScanner.routes');
const customBotsRoutes = require('./routes/customBots.routes');
const backtestRoutes = require('./routes/backtest.routes');
const backtestServiceRoutes = require('./routes/backtestService.routes');
...
const mt5ScannerRoutes = require('./routes/mt5Scanner.routes');
...
app.use('/api/tema34-scanner', tema34ScannerRoutes);
app.use('/api/bist-al-scanner', bistAlScannerRoutes);
app.use('/api/custom-bots', customBotsRoutes);
app.use('/api/backtest', backtestRoutes);
app.use('/api/backtest-service', backtestServiceRoutes);
