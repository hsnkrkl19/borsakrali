...
// gruplama YOK: eksik 1h bar (borsa bakım molası, Yahoo veri deliği)
// sonraki buketlerin hizasını kaydıramaz. (forexKlines.resampleHours ikizi.)
...
module.exports = { fetchCandles, fetchCandlesHistorical, fetchCandlesForward, getSpotPrice, resampleHours };
