...
const SUBDIRS = ['bot', 'crypto-bot', 'tema34-bot', 'custom-bots', 'crossover-alerts', 'tema34-scanner', 'bist-al-scanner', 'pro-signals', 'altin', 'mt5-scanner', 'news-warning', 'bot-center', 'bot-competition', 'ict-fvg', 'bot-builder', 'bist-al-portfolio', 'bist-portfolio'];
