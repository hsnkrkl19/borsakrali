/**
 * proSignalTracker — YENİ ROBOT POZİSYON birleştirme + iz-süren seviye + yaşam döngüsü.
 *
 * forexSignalTracker'ın BİREBİR klonu; tek fark AYRI kalıcılık (forex ile asla
 * çakışmaz) ve proSignals/proInstruments enstrüman kümesi (ön ekler YB/YA/YS/YE).
 *
 * Aynı enstrüman + AYNI YÖN'deki tüm sinyaller (farklı TF'ler ve sonradan yeniden
 ...
 * NO ile teyit. Kalıcılık: Supabase 'bot-state'/'pro-signals/open-signals.json' + disk.
 */
...
const SUPA_KEY = 'pro-signals/open-signals.json';
const DISK_FILE = process.env.PRO_OPEN_SIGNALS_FILE || path.join(__dirname, '..', '..', 'data', 'pro-signals-open.json');
...
// Enstrüman-başına sinyal NO: 2 harf ön ek + 2 hane (YB01..YB99..YB100).
