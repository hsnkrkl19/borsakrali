...
router.get('/status', (_req, res) => {
  try {
    res.json({
      ...
      config: { minAvgScore: notifier.MIN_AVGSCORE, topN: notifier.TOP_N, volMult: notifier.VOL_MULT, minAdx: notifier.MIN_ADX, maxRsi: notifier.MAX_RSI, minTurnover: notifier.MIN_TURNOVER },
    });
  } catch (e) {
