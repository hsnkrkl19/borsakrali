...
const dictionaries = {
  tr: {
    ...
    'mtf.title': 'Çoklu Zaman Dilimi Sinyalleri',
    'mtf.subtitle': '7 timeframe · Confluence engine · Pattern detection · RSI divergence · Volatility regime',
    ...
    'mtf.group.position': 'Pozisyon (Top 30)',
    ...
    'paper.unrealizedPnl': 'Gerçekleşmemiş PnL',
    'paper.totalPnl': 'Toplam PnL',
