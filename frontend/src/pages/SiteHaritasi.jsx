...
const COLOR_MAP = {
  ...
  purple:  { gradient: 'from-gold-400/15 to-gold-500/5',   border: 'border-gold-400/40',   text: 'text-gold-400',  icon: 'text-gold-400',  pill: 'bg-gold-400/20 text-gold-400 border-gold-400/30',  pillHover: 'hover:bg-gold-400/30'  },
