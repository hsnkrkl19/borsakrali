        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-sm font-medium text-white">
              {message || 'Premium ozelliklere ulasmak icin ucretsiz hesap acin'}
            </p>
            <p className="mt-0.5 text-xs text-gray-400">
              Sinyaller, AI skor, takip listesi ve daha fazlasi
            </p>
          </div>
          <Link
            to="/register"
          ...
          >
            Kayit Ol <ArrowRight className="h-3 w-3" />
          </Link>
        </div>
      </div>
    )
    ...
    <div className="mb-4 overflow-hidden rounded-2xl border border-gold-500/30 bg-gradient-to-r from-gold-500/15 via-amber-500/10 to-gold-500/15 p-4 sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h3 className="text-sm font-bold text-white sm:text-base">
              Borsa Krali Premium ile tum ozellikleri kullanin
            </h3>
            <p className="mt-1 text-xs text-gray-300 sm:text-sm">
              Gunluk AI sinyalleri, takip listesi, AI skor, mali tablo analizi ve daha fazlasi.
              Ucretsiz hesap ile baslayin.
            </p>
          </div>
        </div>
        <div className="flex flex-shrink-0 gap-2">
          ...
          >
            Ucretsiz Kayit Ol <ArrowRight className="h-3.5 w-3.5" />
          </Link>
        </div>
      </div>
    </div>
