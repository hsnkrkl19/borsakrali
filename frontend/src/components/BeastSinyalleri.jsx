    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-xs md:text-sm text-gray-400 mt-1 max-w-2xl">
            ...
            <b> 1h / 4h / 8h / 1d</b> — her parite kendi en iyi zaman diliminde (kripto alt TF, altın/gümüş üst TF).
            Trend-<b>devamı</b> sistemi: üst zaman dilimi trend kapısı + parite başına tek yön (çelişki yok) + dar yapısal stop.
            Zarar eden TF'ler her paritede kapalı.
          </p>
        </div>
      ...
      {bt && (
        <div className="rounded-lg border border-emerald-500/25 bg-emerald-500/5 p-3 text-xs text-gray-300 flex items-start gap-2">
          ...
          <div>
            <b className="text-emerald-300">Backtest (parite-özel TF):</b> en güçlü <b>Ons Altın 1d %90 · Gümüş 8h %75 · ETH 1d %73</b>.
            Alt TF'ler (1h) daha sık ama daha düşük isabet (~%46-54). Zarar eden TF'ler her paritede kapalı.
            Not: trend sistemi — her sinyal tutmaz, kazançlar kayıplardan büyük olur.
