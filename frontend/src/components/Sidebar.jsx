...
const navItems = [
  ...
  { path: '/canli-heatmap', label: 'Canlı Heatmap', icon: Flame, highlight: true },
  { path: '/malaysian-snr', label: 'Malaysian SNR', icon: CandlestickChart, highlight: true, badge: 'YENİ' },
  { path: '/ema34-tarayici', label: 'EMA34 Takip', icon: TrendingUp, highlight: true, badge: 'YENİ' },
  ...
  { path: '/inceleme-kutuphanesi', label: 'İnceleme Kütüphanesi', icon: BookOpen },
          ...
          {isOpen ? (
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-semibold text-white truncate">Borsa Kralı</div>
